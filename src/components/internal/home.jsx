...
import { TbBoxSeam, TbCoinRupee, TbReceipt, TbCircleLetterQ ,TbMoneybag} from "react-icons/tb";
                        ...
                        <div className="page-content-wrapper">
                            <div className="container-fluid">
                                ...
                                <div className='row' style={{justifyContent:"space-between"}}>
                                    <div className="col-xl-7" style={{ maxWidth:""}}>
                                        <div className="card mini-stat m-b-30 card-resp">
                                            <div className="p-3  bg-card text-white" >
                                                <div className="no-opacity ">
                                            ...
                                            <div className="" >
                                                <div className="">
                                                    <div className="">
                                                        <div className='cr-act-box' style={{ marginTop: "25px", marginLeft: "20px",  height:"180px"}}>
                                    ...
                                    <div className="col-xl-5">
                                        <div className="card  mini-stat m-b-30 ret-card"  >
                                            <div className="p-3  text-black " style={{ textAlign: "center" }}>
                                                <h6 className="text-uppercase mb-0 text-bold" style={{ paddingTop: "5px !important", fontWeight:"bolder" }}>
                                                    {/* <TbMoneybag  style={{fontSize: '20px', width: '30px', margin: 'auto', padding:"auto" }}/> */}
                                                    Retained Amount</h6>
                                            </div>
                                            <div className="card-body no-opacity">
                                                <div className="ret-card-child">
                                                    <span className=" text-muted text-b m-btm-10 " >Number of Invoices: <b>5</b></span>
                                                    <span className=" text-black text-b m-btm-10">Subvention</span>
                                                    <span className=" text-muted text-b">Subvention Amount</span>
                                                    <span className=" price text-b m-btm-10">34000.00 <a className="badge badge-warning">Monthly</a></span>
                                                    <span className=" text-muted text-b">Subvention Days</span>
                                                    <span className=" text-bold m-btm-10">30 Days</span>
                                                </div>
                                                <div className="ret-card-right">
                                                    {/* Next due date */}
                                                    <span className="text-muted text-b">Next Due Date</span>
                                                    <span className="text-bold m-btm-10 text-success">2023-07-15</span>

                                                    {/* Cash Security */}
                                                    <span className="text-muted text-b">Cash Security</span>
                                                    <span className="price text-bold m-btm-10">5000.00</span>
                                                </div>
